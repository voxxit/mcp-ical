...
describe("CalendarManager - Edge Cases", () => {
  ...
  describe("Recurring Events", () => {
    ...
    it.skip("should handle EXDATE exclusions in recurring events", async () => {
      ...
      const standupEvents = events.filter(e => e.summary === "Weekly Team Standup");
  ...
  describe("Timezone Handling", () => {
    ...
    it("should handle events with timezone information", async () => {
      const events = await calendarManager.searchEvents("International Conference");
    ...
    it("should handle events in different timezones correctly", async () => {
      ...
      const intlEvent = events.find(e => e.summary === "International Conference Call");
