/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a34e52baca46309ae55b4d72c0eca2fa)
// Runtime types generated with workerd@1.20250816.0 2025-08-16 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		AUTH_STORE: KVNamespace;
		CALENDARS: KVNamespace;
		STYTCH_PROJECT_ENV: "test" | "live";
		STYTCH_DOMAIN: "https://login-test.srv.im" | "https://api.stytch.com";
		MCP_SERVER_NAME: "iCal MCP Server";
		MCP_SERVER_VERSION: "1.0.0";
		FRONTEND_URL: "http://localhost:8787";
		STYTCH_PROJECT_ID: string;
		STYTCH_SECRET_KEY: string;
		STYTCH_PUBLIC_TOKEN: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/hono-worker").MCP>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STYTCH_PROJECT_ENV" | "STYTCH_DOMAIN" | "MCP_SERVER_NAME" | "MCP_SERVER_VERSION" | "FRONTEND_URL" | "STYTCH_PROJECT_ID" | "STYTCH_SECRET_KEY" | "STYTCH_PUBLIC_TOKEN">> {}
}
